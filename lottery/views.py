...
def create_draw():
    ...
    if form.validate_on_submit():
        ...
        new_draw = Draw(user_id=current_user.id, numbers=submitted_numbers, master_draw=False, lottery_round=0, lottery_key=current_user.lottery_key)
...
def view_draws():
    ...
    # Decrypts the numbers in playable draws
    for numbers in playable_draws:
        make_transient(numbers)
        numbers.view_numbers(current_user.lottery_key)
